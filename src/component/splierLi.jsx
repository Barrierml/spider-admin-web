    ...
    return (<div className=" relative hover:bg-light-blue-500 transition  hover:border-transparent hover:shadow-lg group block rounded-lg p-4 border border-gray-200">
        ...
        <dl className="grid sm:block lg:grid xl:block grid-cols-2 grid-rows-2 items-center">
            ...
            <div className="flex items-center sm:mb-4 lg:mb-0 xl:mb-4 space-x-2">
                <dd className="rounded-full bg-green-400 h-4 w-4"></dd>
            ...
            <div className="mt-2 col-start-2 row-start-1 row-end-3 flex space-x-2 flex-row">
                <button className="hover:bg-light-blue-200 hover:text-light-blue-800 group flex items-center rounded-md bg-light-blue-100 text-light-blue-600 text-sm font-medium px-4 py-2">运行</button>
            ...
            <div className="mt-2 col-start-3 row-span-2 flex items-center justify-between">
                <span className=" flex-shrink truncate text-gray-600 group-hover:text-white">2012-12-21 开始运行啊哈哈哈哈哈哈哈哈哈哈哈哈</span>
                <button class="ml-2 flex-shrink-0 text-sm font-medium transition-colors duration-200 ring-2 p-1 ring-current outline-none rounded-md text-violet-600 group-hover:text-gray-100">查看全部日志</button>
            </div>
        </dl>
